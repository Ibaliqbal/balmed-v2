"use client";
import { getInfiniteTopPostByHastag } from "@/actions/post";
...
const HastagTopPostView = ({
  ...
  const {
    ...
    queryKey: ["post", `hastag-${id}`, "top"],
    queryFn: async ({ pageParam }) =>
      await getInfiniteTopPostByHastag(postsId, pageParam),
    initialPageParam: 0,
...
export default HastagTopPostView;
